...
public:
    ...
    int begin(CRGB newPtr[], uint8_t longCount, uint8_t shortCount, uint8_t newGap, bool leftRight, bool dataTop, int layout);
    int begin(CRGB newPtr[], const uint8_t segmentIndices[14][2]);
